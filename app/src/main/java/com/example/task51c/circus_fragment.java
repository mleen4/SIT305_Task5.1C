 ...
 * Use the {@link circus_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class circus_fragment extends Fragment {

    RecyclerView circusRecycleView;
     ...
     * @return A new instance of fragment circus_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static circus_fragment newInstance(String param1, String param2) {
        circus_fragment fragment = new circus_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_circus_fragment, container, false);

        circusRecycleView = view.findViewById(R.id.circusRecycleView);
        circusRecycleView.setLayoutManager(new LinearLayoutManager(getContext()));
        circusRecycleView.setAdapter(new MainStoriesAdapter(addData(), getActivity().getApplicationContext(), (MainStoriesAdapter.OnMainStoryListener) getContext()));
