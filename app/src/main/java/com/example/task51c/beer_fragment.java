 ...
 * Use the {@link beer_fragment#newInstance} factory method to
...
public class beer_fragment extends Fragment {
     ...
     * @return A new instance of fragment beer_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static beer_fragment newInstance(String param1, String param2) {
        beer_fragment fragment = new beer_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        beerRecycleView = view.findViewById(R.id.beerRecycler);
        beerRecycleView.setLayoutManager(new LinearLayoutManager(getContext()));


        beerRecycleView.setAdapter(new MainStoriesAdapter(addData(), getActivity().getApplicationContext(), (MainStoriesAdapter.OnMainStoryListener) getContext()));
